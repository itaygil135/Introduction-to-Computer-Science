...
class GameRunner:
    ...
    def new_spot_ship(self):
        self._x = self.__screen_min_x + ((self._x + self.my_ship.get_speed_x())%(self.__screen_max_x - self.__screen_min_x ))
        self._y = self.__screen_min_y + ((self._y + self.my_ship.get_speed_y())%(self.__screen_max_y - self.__screen_min_y))
        return self._x,self._y
